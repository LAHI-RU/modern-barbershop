            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="duration_minutes" class="mt-1 block w-full border-gray-300 rounded" value="30" required />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Price (cents)</label>
                        <input type="number" name="price_cents" class="mt-1 block w-full border-gray-300 rounded" value="0" required />
                    </div>
                </div>
